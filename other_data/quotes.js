...
exports.quotes = exports.mental_models = exports.get_quote = void 0;
function get_quote() { return exports.quotes[Math.floor(Math.random() * exports.quotes.length)]; }
exports.get_quote = get_quote;
exports.mental_models = [
    `Occam's Razor: the simplest explanation is usually the correct one https://simple.wikipedia.org/wiki/Occam%27s_razor`,
    `Einstein’s razor: “everything should be made as simple as possible, but not simpler”`,
    `The 80/20 rule (Pareto Principle): 80% of the results come from 20% of the effort, the final 20% of results require 80% of the effort`,
    ``
];
exports.quotes = [
    `"Know your strongest Point — your pre-eminent gift; cultivate that and you will assist the rest. Every one would have excelled in something if he had known his strong point. Notice in what quality you surpass, and take charge of that." - Balthasar Gracian`,
    ...
    `“We don’t take pictures, when you’re rich you just see it again.” - Childish Gambino`,
    `“Don’t think, just do” - Maverick, Top Gun 2`,
    ...
    `“You overestimate what you can do in a year and underestimate what you can do in 10 years.” - Bill Gates`,
    `a non-zero chance of death is required to pendent zero chance of life (personal)`,
    `"I try to keep in mind that if I dropped dead tomorrow, all of my acrylic workplace awards would be in the trash the next day and my job would be posted in the paper before my obituary." - Bernie Klinder`,
    ...
    `"love is knowing something deeply" - Ann Druyan`,
    ...
    `"To the most trivial actions, attach the devotion and mindfulness of a hundred monks. To matters of life and death, attach a sense of humor." - Chinese philosopher Zhuangzi`,
    `“What is more important? The human value of the dollar, or the value dollar of the human?” - Jonas Salk (discoverer of the polio vaccine)`,
    ...
    `What people do now on the weekends is what people 10 years from now will be doing during the week - Chris Dixon (not exact quote)`, `Your direction is more important than your speed`,
    `Diversify domains to decrease commitment`,
    `"Our dinners weren’t talking all about Apple tariffs and technology. I’d say 75% was talking about life. To be a good CEO, to get things accomplished, you have to be personable, you have to be a good communicator and a good listener, and Tim was all of those things." - The Fortress that Tim Cook Built`,
    ...
    `"Lessons are repeated until they are learned. A lesson will be presented to you in various forms until you have learned it. When you have learned it, you can go on to the next lesson. Learning lessons does not end. There's no part of life that doesn't contain its lessons. If you're alive, that means there are still lessons to be learned." - Cherie Carter-Scott in If Life is a Game, These are the Rules`,
    ...
    `"Just like children, emotions heal when they are heard and validated." - Jill Boyle Taylor`,
    ...
    `"That art thou" - Buddhist saying`,
    `"We are in the habit of imagining our lives to be linear, a long march from birth to death in which we mass our powers, only to surrender them again, all the while slowly losing our youthful beauty. This is a brutal untruth. Life meanders like a path through the woods. We have seasons when we flourish and seasons when the leaves fall from us, revealing our bare bones. Given time, they grow again." - Katherine May`,
    `“Like our stomachs, our minds are hurt more often by overeating than by hunger.” (Ut stomachis sic ingeniis nausea sepius nocuit quam fames.) - Petrarch`,
    ...
    `"We generate fears when we sit. We overcome then with action." -`, `“The best way to predict the future is to create it” - Peter Drucker`,
    ...
    `"Learning is the only thing the mind never exhausted, never fears, and never regrets." - Leonardo da Vinci`,
    ...
    `“Happy families are all alike; every unhappy families is unhappy in its own way.” - Leo Tolstoy`,
    ...
    `“Don’t tell people how to do things, tell them what you need done and let them surprise you with their results.” - Patton`,
    `“It takes more than one human brain to create a human mind” - Lisa Feldman Barrett`,
    `“A person’s success in life can usually be measured by the number of uncomfortable conversations he or she is willing to have” - Tim Ferriss`,
    `“We cannot change that we are not aware of, and once we are aware, we cannot help but change” - Sheryl Sandberg`,
    `“Get over “blame” and “credit” and get on with “accurate” and “inaccurate”” - Ray Dalio principle`,
    `“Regret for the things we did can be tempered by time; it is regret for the things we did not do that is inconsolable” - Sydney Harris`,
    `“Real failure is trying something, learning it doesn’t work, then continuing to do it anyway” - Astro Teller, Captain at Moonshot X`,
    `“It is not death that a man should fear, but he should fear never beginning to live” - Marcus Aurelius`,
    `“The greatest enemy of learning is knowing” - John Maxwell`, `“The best is the enemy of the good” - Voltaire`,
    ...
    `“Conversation is to be thought of as creating a social world just as causality generates a physical one” - Rom Harré`,
    ...
    `“Set aside a certain number of days, during which you shall be content with the scantiest and cheapest fare, with coarse and rough dress, saying to yourself the whole: ‘Is this the condition I feared?’” - Seneca`,
    `“I am an old man and have known a great many troubles, but most of them never happened.” - Mark Twain`,
    `"Life should not be a journey to the grave with the intention of arriving safely in a pretty and well preserved body, but rather to skid in broadside in a cloud of smoke, thoroughly used up, totally worn out, and loudly proclaiming: 'Wow! What a Ride!'" - Hunter S. Thompson`,
    `“Do every act of life as if it was the last act of your life” - Marcus Aurelius`,
    `“When you find peace within yourself, you become the kind of person who can love at peace with others.” - Peace Pilgrim`,
    `“Perfectionism leads to procrastination, which leads to paralysis.” - Whitney Cummings`,
    `“People pleasing is a form of assholery”`,
    `“The difference between people you admire and everybody else is that the former are the people who read” - Bryan Callen to David Blaine, inspiring Blaine to read extensively`,
    `“The world is changed by your example, not by your opinion” - Paulo Coelho`,
    `“Honor those who seek truth, beware of those who’ve found it” - Voltaire`,
    `“Whenever you find yourself on the side of the majority, it’s time to pause and reflect” - Mark Twain`,
    `“The limits of my language mean the limits of my world” - Ludwig Wittgenstein`,
    `“Robustness is when you care more about the few who like your work than the multitude who hates it; fragility is when you care more about the few who hate your work than the multitude who loves it” - Nassim Taleb`,
    ...
    `“The hero and the coward feel the same thing, but the hero uses his fear, projects it onto his opponent, while the coward runs. It’s the same thing – fear – but it’s what you do with it that matters.” - Cus D’Amato, Mike Tyson’s first coach, telling his athletes before big fights`,
    `“A person’s success in life can usually be measured by the number of uncomfortable conversations he or she is willing to have” - Tim Ferriss`,
    ...
    `“Be the needle in the haystack of history”`,
    `“Mind fire-colliding neurons-consciousness”`,
    `"Humanity represents an accumulation of collective ideas"`,
    `"Every cell in the universe is autonomously supported by the rest of the universe"`,
    `"Instead of dwelling in the past, create the future"`,
    `"When shit happens, don’t swim in it"`,
    `"Chance will stop you in your tracks because change has no beginning and no end"`,
    `"There is no difference between creation and evolution. Things are created to evolve, equally."`,
    `"The universe is made of 0s and 1s - from 0 nothingness to 1 consciousness"`,
    `"We all benefit from the ingenuity of the collective human mind"`,
    `"The ideas of the living feed on the ideas of the dead."`, `"We arrive naive. We depart with some understanding"`,
    `"History is an interpretation of facts, but these facts remain uncertain and obscured"`,
    `"How can anything that’s said be true when it’s interpreted differently by everyone else?"`,
    `"No matter what happens, it will still be different"`,
    `"The unknown is the source of all knowledge"`,
    `"You can readily organize your chaos because order underlies chaos"`
];
